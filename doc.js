import { h, is, jc, nanolightJs, s, svgUse } from 'https://unpkg.com/@jackens/nnn/nnn.js'
import { marked } from 'https://unpkg.com/marked/lib/marked.esm.js'

document.title = 'nnn • Documentation'

const names = []
const res = await fetch('https://unpkg.com/@jackens/nnn/readme.md')
const md = await res.text()
const div = h('div', { $innerHTML: marked(md) })

Array.from(div.querySelectorAll('h1,h2,h3,h4')).forEach((e, i, eArr) => {
